...
>The Transformer Neural Network is a novel architecture that aims to solve <mark>sequence-to-sequence tasks</mark> while handling long-range dependencies with ease. It was proposed in the paper [_Attention Is All You Need.pdf_](https://arxiv.org/abs/1706.03762) 2017. It is the current state-of-the-art technique in the field of NLP.

### Recap & Motivations

#### [RNNs (Recurrent Neural Networks)](/blogs/learning_ai/models/rnns_(recurrent_neural_networks))

Are feed forward networks rolled out over time.

![tanh_activated_rnn.png](/images/learning_ai/tanh_activated_rnn.png)

Unlike [FFNNs (Feed Forward Neural Networks)](/blogs/learning_ai/models/ffnns_(feed_forward_neural_networks)), are designed to take a **series of inputs** with not predetermined limit on size. "Series" as in any input with relationships between in-between it's members, or has some form of influence on them.


![rolled_out_rnn.png](/images/learning_ai/rolled_out_rnn.png)
...
It is used in a variety of models (elaboration on each on in [Definitions](/blogs/learning_ai/glossary)):
...
#### [LSTM (Long Short-Term Memory) Models](/blogs/learning_ai/models/lstm_(long_short-term_memory)_models)

![lstm_network.webp](/images/learning_ai/LSTM_network.webp)
...
![lstm_cell_state.webp](/images/learning_ai/LSTM_cell_state.webp)
...
![seq2seq.gif](/images/learning_ai/seq2seq.gif)
...
![seq2seq_attention.gif](/images/learning_ai/seq2seq_attention.gif)
...
![general_attention.webp](/images/learning_ai/general_attention.webp)
...
![seq2seq_attention_detailed.gif](/images/learning_ai/seq2seq_attention_detailed.gif)

That is the basics of attention. The main thing i would say is the scoring of the hidden states.

### Parallelisation i.e. [Transformers](/blogs/learning_ai/models/transformers)!
