...
![rnn_example_with_rabbit.png](/images/learning_ai/RNN_example_with_rabbit.png)
...
![encoder_decoder_exposed.png](/images/learning_ai/encoder_decoder_exposed.png)
*This figure also reveals that encoders and decoders are just [RNNs (Recurrent Neural Networks)](/blogs/learning_ai/models/rnns_(recurrent_neural_networks))*
