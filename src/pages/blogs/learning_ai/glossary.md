...
- [attention heads](/blogs/learning_ai/attention/general_attention)
- input token \[CLS]
- [self attention mechanism](/blogs/learning_ai/attention/self_attention)
...
- Softmax: turns vector into probabilities (extension of logistic regression). The softmax function is a function that turns a vector of K real values into a vector of K real values that sum to 1. The input values can be positive, negative, zero.
- ![softmax.jpg](/images/learning_ai/softmax.jpg)
